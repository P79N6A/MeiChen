...
@interface MemberCollLayout () {
    CGFloat left;
    CGFloat gap;
}
@end

@implementation MemberCollLayout
...
//卡片宽度
- (CGFloat)cellWidth {
    return (self.collectionView.bounds.size.width-30*2);
}
...
//cell大小
- (CGSize)itemSize {
    return CGSizeMake([self cellWidth],202.0/317.0*[self cellWidth]);
}
