...
@interface MyPlanView_3 ()

@end

@implementation MyPlanView_3

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:@"MyPlanView_3" owner:nil options:nil] firstObject];
        self.frame = frame;
...
- (void)settingLab_6 {
    self.lab_6.text = [NSString stringWithFormat:@"%@:",NSLocalizedString(@"MyPlanVC_22", nil)];
